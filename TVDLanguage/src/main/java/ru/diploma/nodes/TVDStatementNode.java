...
@NodeInfo(language = "TVD", description = "The abstract base node for all TVD statements")
@GenerateWrapper
@ReportPolymorphism
public abstract class TVDStatementNode extends Node implements InstrumentableNode {
    ...
    public WrapperNode createWrapper(ProbeNode probe) {
        return new TVDStatementNodeWrapper(this, probe);
    }
