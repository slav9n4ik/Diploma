...
/**
 * Base class for all TVD nodes that produce a value and therefore benefit from type specialization.
 * The annotation {@link TypeSystemReference} specifies the TVD types. Specifying it here defines the
...
public abstract class TVDExpressionNode extends TVDStatementNode {
    ...
    /**
     * When we use an expression at places where a {@link TVDStatementNode statement} is already
    ...
    public WrapperNode createWrapper(ProbeNode probe) {
        return new TVDExpressionNodeWrapper(this, probe);
    }
    ...
    public boolean executeBoolean(VirtualFrame frame) throws UnexpectedResultException {
        return TVDTypesGen.expectBoolean(executeGeneric(frame));
    }
