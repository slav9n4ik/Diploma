...
public class TVDLanguageParser extends Parser {
	...
	public static final int
		...
		NUMERIC_LITERAL=8;
	public static final int
		RULE_tvdlanguage = 0, RULE_statement = 1, RULE_sum = 2, RULE_numeric = 3, 
		RULE_member_expression = 4;
	private static String[] makeRuleNames() {
		return new String[] {
			"tvdlanguage", "statement", "sum", "numeric", "member_expression"
		};
	}
	...
	public final TvdlanguageContext tvdlanguage() throws RecognitionException {
		...
		try {
			...
			{
			setState(16);
			((TvdlanguageContext)_localctx).s = match(T__0);

			                                           factory.startBlock(((TvdlanguageContext)_localctx).s, ((TvdlanguageContext)_localctx).block);
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << WHITESPACE) | (1L << IDENTIFIER) | (1L << NUMERIC_LITERAL))) != 0)) {
				...
				do {
					...
					case 1:
						...
						{
						setState(18);
						((TvdlanguageContext)_localctx).statement = statement();
						}
						}
						break;
					default:
				 ...
				 body.add(((TvdlanguageContext)_localctx).statement.result); 
				setState(27);
				_errHandler.sync(this);
			...
			setState(35);
			((TvdlanguageContext)_localctx).e = match(T__1);
			 factory.finishBlock(body, ((TvdlanguageContext)_localctx).s.getStartIndex(), ((TvdlanguageContext)_localctx).e.getStopIndex() - ((TvdlanguageContext)_localctx).s.getStartIndex() + 1); 
			}
			}
		}
	...
	public static class StatementContext extends ParserRuleContext {
		public TVDStatementNode result;
		public Token r;
		...
		public TerminalNode IDENTIFIER() { return getToken(TVDLanguageParser.IDENTIFIER, 0); }
		public Member_expressionContext member_expression() {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TVDLanguageListener ) ((TVDLanguageListener)listener).enterStatement(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TVDLanguageListener ) ((TVDLanguageListener)listener).exitStatement(this);
		}
	}
		...
		try {
			...
			case IDENTIFIER:
				...
				((StatementContext)_localctx).IDENTIFIER = match(IDENTIFIER);
				 TVDExpressionNode assignmentName = factory.createStringLiteral(((StatementContext)_localctx).IDENTIFIER, false); 
				setState(49);
	...
	public static class NumericContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TVDLanguageListener ) ((TVDLanguageListener)listener).enterNumeric(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TVDLanguageListener ) ((TVDLanguageListener)listener).exitNumeric(this);
		}
	}
	...
	public static class Member_expressionContext extends ParserRuleContext {
		public TVDExpressionNode assignmentName;
		public TVDExpressionNode result;
		public SumContext sum;
		public NumericContext numeric;
		public Token e;
		...
		public Member_expressionContext(ParserRuleContext parent, int invokingState, TVDExpressionNode assignmentName) {
			super(parent, invokingState);
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TVDLanguageListener ) ((TVDLanguageListener)listener).enterMember_expression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TVDLanguageListener ) ((TVDLanguageListener)listener).exitMember_expression(this);
		}
	}

	public final Member_expressionContext member_expression(TVDExpressionNode assignmentName) throws RecognitionException {
