...
public final class TLLObjectType extends ObjectType {
    ...
    public static final ObjectType SINGLETON = new TLLObjectType();

    private TLLObjectType() {
    }

    @Override
    public Class<?> dispatch() {
        return TLLObjectType.class;
    }
    ...
    abstract static class WriteMember {
         ...
         * {@link TLLWritePropertyCacheNode#writeNewPropertyCached} because there we perform a shape
