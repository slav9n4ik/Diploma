...
public final class TVDObjectType extends ObjectType {

    protected static final int CACHE_LIMIT = 3;
    public static final ObjectType SINGLETON = new TVDObjectType();

    private TVDObjectType() {
    }

    @Override
    public Class<?> dispatch() {
        return TVDObjectType.class;
    }
    ...
    abstract static class WriteMember {
         ...
         * {@link TVDWritePropertyCacheNode#writeNewPropertyCached} because there we perform a shape
