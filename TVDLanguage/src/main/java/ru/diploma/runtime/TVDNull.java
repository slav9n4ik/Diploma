...
/**
 * The TVD type for a {@code null} (i.e., undefined) value. In Truffle, it is generally discouraged
...
public class TVDNull implements TruffleObject {

    /**
     * The canonical value to represent {@code null} in SL.
     */
    public static final TVDNull SINGLETON = new TVDNull();
    ...
    /**
     * {@link TVDNull} values are interpreted as null values by other languages.
     */
    @ExportMessage
    boolean isNull() {
        return true;
