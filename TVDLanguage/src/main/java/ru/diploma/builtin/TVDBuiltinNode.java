 ...
 * The builtin functions are registered in {@link TVDContext#installBuiltins}. Every builtin node
 * subclass is instantiated there, wrapped into a function, and added to the
 * {@link TVDFunctionRegistry}. This ensures that builtin functions can be called like user-defined
...
@GenerateNodeFactory
public abstract class TVDBuiltinNode extends TVDExpressionNode {
    ...
    public final Object executeGeneric(VirtualFrame frame) {
        try {
            ...
            throw TVDException.typeError(e.getNode(), e.getSuppliedValues());
        }
    }
